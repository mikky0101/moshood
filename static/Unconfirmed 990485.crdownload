...
var bitcoincashCurrentPrice = document.getElementById("bitcoincash-current-price");
var bitcoincashPercentChange = document.getElementById("bitcoincash-percent-change");
